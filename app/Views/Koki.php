...
<li class="nav-item">
    ...
    <td align="center" scope="col">Nama Koki</td>
...
$no = 1;
foreach ($s as $key) {
    if ($key->level === "Koki" && $key->Soft === "Restore") { // Add this condition
?>
    <tr>
          <td align="center" scope="col"><?= $no++ ?></td>
        ...
        <td align="center">
                ...
                <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                    <li class="dropdown-header">
                        <h6>
                            <a href="<?= base_url('home/MAdelete1/'.$key->id_user)?>">
                                <i class="btn btn-danger">delete</i>
                            </a>
                            <a href="<?= base_url('home/Reset4/'.$key->id_user)?>">
